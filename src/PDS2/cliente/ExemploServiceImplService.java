 ...
 * 
 */
@WebServiceClient(name = "ExemploServiceImplService", targetNamespace = "http://PDS2/", wsdlLocation = "http://localhost:8080/exemplo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXEMPLOSERVICEIMPLSERVICE_QNAME = new QName("http://PDS2/", "ExemploServiceImplService");
    ...
    public ExemploService getExemploServiceImplPort() {
        return super.getPort(new QName("http://PDS2/", "ExemploServiceImplPort"), ExemploService.class);
    }
    ...
    public ExemploService getExemploServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://PDS2/", "ExemploServiceImplPort"), ExemploService.class, features);
    }
